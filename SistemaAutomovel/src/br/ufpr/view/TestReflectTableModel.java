...
public class TestReflectTableModel extends JPanel {
    ...
    public TestReflectTableModel() {
        ...
        simpleReflectTableModel.setDataList(Arrays.asList(new Cliente(WIDTH, TOOL_TIP_TEXT_KEY, TOOL_TIP_TEXT_KEY, TOOL_TIP_TEXT_KEY, TOOL_TIP_TEXT_KEY, TOOL_TIP_TEXT_KEY)));
